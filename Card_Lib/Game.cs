/**Game.cs - Game class, the game itself and its logic
 * 
...
namespace Card_Lib
{
    ...
    public class Game
    {
        ...
        /// <summary>
        /// SetPlayers - set new player
        /// </summary>
        /// <param name="newPlayers">new player</param>
